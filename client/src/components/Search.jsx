        ...
        <div>
            {
                (isMobile && isSearchPage ) ? (
                    ...
                    <button className='flex justify-center items-center h-full p-3 group-focus-within:text-black'>
                        <IoSearch size={22}/>
                    </button>
                )
            }
                     ...
                     <div onClick={redirectToSearchPage} className='w-full h-full flex items-center'>
                        <TypeAnimation
                                  sequence={[
                                    ...
                                    'Search "Brake Pads"',
                                    1000,
                                    'Search "Windshield Wipers"',
                                    1000,
                                    'Search "Rearview Mirrors"',
                                    1000,
                                    'Search "Headlights"',
                                    1000,
                                    'Search "Car Batteries"',
                                    1000,
                                    'Search "Tires"',
                                    1000,
                                    'Search "Engine Heads"',
