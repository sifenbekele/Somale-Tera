  ...
  return (
    <div>
        ...
        <div className='text-sm grid gap-1'>
            ...
            <Link onClick={handleClose} to={"/dashboard/myorders"} className='px-2 hover:bg-black hover:text-white py-1'>My Orders</Link>

            <Link onClick={handleClose} to={"/dashboard/address"} className='px-2 hover:bg-black hover:text-white py-1'>Save Address</Link>

            <button onClick={handleLogout} className='text-left px-2 hover:bg-black hover:text-white  py-1'>Log Out</button>
