        ...
        <form className='my-4 grid gap-4' onSubmit={handleSubmit}>
            ...
            <div className='grid'>
                ...
                <input
                    type='email'
                    id='email'
                    placeholder='Enter your email Nigga' 
                    className='p-2 bg-blue-50 outline-none border focus-within:border-primary-200 rounded'
            ...
            <div className='grid'>
                ...
                <input
                    type='text'
                    id='mobile'
                    placeholder='Enter your mobile Nigga' 
                    className='p-2 bg-blue-50 outline-none border focus-within:border-primary-200 rounded'
            ...
            <button className='border px-4 py-2 font-semibold hover:bg-black border-black text-black hover:text-white rounded'>
                {
